...
public class PolyService {
	public void ex1() {
		...
		//다형성을 이용한 객체배열 : 부모타입 참조 자료형의 변수를 하나의 묶음으로 다루는 것
	...
	public void ex3() {
		...
		// 주의 !
		// "." 연산자가 (Tesla) 형변환 연사자보다 우선순위 높음
		// 그래서 형변환하는 부분을 () 로 한반 묶어주고나서 . 연산을 진행해야
	...
	public void ex5() {
		...
		// 하지만 실행해보면 자식(Spark)의 toString()이 호출 되는것을 확인
