...
public class Student implements Comparable<Student>{
	...
	private int age; // 나이
	private String retion; // 지역
	private char gender; // 성별
	private int score; // 점수
	
	public Student() {}

	public Student(String name, int age, String retion, char gender, int score) {
		super();
		this.name = name;
		this.age = age;
		this.retion = retion;
	...
	public String toString() {
		return "Student [name=" + name + ", age=" + age + ", retion=" + retion + ", gender=" + gender + ", score="
				+ score + "]";
	}
